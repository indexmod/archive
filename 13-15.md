...
(2010, Moscow) is a fashion brand founded by stylist Vladimir Bordoque <span id="a1">[\[1\]](#f1)</span>. [Edit the "{{page.title}}" page now](http://prose.io/#indexmod/encyclopedia/edit/master/{{page.path}})
